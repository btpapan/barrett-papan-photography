const photos = [
  ...
  { slug: 'hummingbird', category: 'wildlife', width: 2048, height: 1365, alt: 'A hummingbird perched among dried flower heads.' },
  { slug: 'american-coot', category: 'wildlife', width: 2678, height: 1785, alt: 'Two American coots resting at the edge of the water.' },
  ...
  { slug: 'wetland-heron', category: 'wildlife', width: 2048, height: 1365, alt: 'A heron standing on a low branch above a green wetland.' },
  ...
  { slug: 'duck-portrait', category: 'wildlife', width: 6000, height: 4000, alt: 'A resting Muscovy duck seen between branches.' },
  { slug: 'alligator', category: 'wildlife', width: 6000, height: 4000, alt: 'An alligator resting beneath a fallen tree in warm light.' },
  { slug: 'squirrel-in-grass', category: 'wildlife', width: 2650, height: 1767, alt: 'A squirrel standing upright in tall green grass.' },
  ...
  { slug: 'snowy-street', category: 'places', width: 5925, height: 3950, alt: 'Homes and parked cars along a snow-covered city street.' },
  { slug: 'city-skyline', category: 'places', width: 4818, height: 3212, alt: 'A city skyline seen across a river in winter light.' },
  { slug: 'winter-berries', category: 'details', width: 4896, height: 3264, alt: 'Red berries and green leaves lit from behind.' },
  { slug: 'purple-flowers', category: 'details', width: 2728, height: 1830, alt: 'Soft purple flowers in cool evening color.' },
  { slug: 'pink-zinnia', category: 'details', width: 2591, height: 1738, alt: 'A pink zinnia against circular highlights and shadow.' },
  { slug: 'passionflower', category: 'details', width: 2728, height: 1830, alt: 'A pale purple passionflower against deep green leaves.' }
];
